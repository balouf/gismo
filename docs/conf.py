...
version = gismo.__version__
# The full version, including alpha/beta/rc tags.
release = gismo.__version__
...
latex_documents = [
    (master_doc, "gismo.tex", "GISMO Documentation", "Fabien Mathieu", "manual"),
]
...
man_pages = [(master_doc, "gismo", "GISMO Documentation", [author], 1)]
